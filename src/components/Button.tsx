...
const baseStyles = {
  solid:
    "inline-flex justify-center rounded-xl py-2 px-3 text-sm font-semibold outline-2 outline-offset-2 transition-colors",
  outline:
    "inline-flex justify-center rounded-xl border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm outline-2 outline-offset-2 transition-colors",
}
...
const variantStyles = {
  ...
  outline: {
    ...
    blue: "border-blue-300 text-blue-700 hover:border-blue-400 active:bg-blue-100 active:text-blue-700/80",
  },
}
